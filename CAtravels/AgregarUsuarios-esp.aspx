<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AgregarUsuarios-esp.aspx.cs" Inherits="CAtravels.AgregarUsuarios_esp" %>
...
<body>
	...
	<div class="container">
		...
		<form id="form1" runat="server">
			<asp:Label ID="LUsername" runat="server" Text="Nombre de Usuario:"></asp:Label>
            <br />
            <asp:TextBox ID="Txtusername" runat="server" cssClass="input" Width="433px" MaxLength="10"></asp:TextBox>
            <br />
			Nombre:<br />
...
&nbsp;Correo:<br />
            ...
            <br />
            Contraseña:<br />
            <asp:TextBox ID="Txtcontra" runat="server" cssClass="input" Width="433px"  required TextMode="Password" MaxLength="7"></asp:TextBox>
			&nbsp;<br />

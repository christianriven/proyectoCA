...
namespace CAtravels
{
    public partial class LoginEmpresa_esp : System.Web.UI.Page
    {
        ...
        protected void btnlogin_Click(object sender, EventArgs e)
        {
            ...
            if (txtAname.Text != "" && txtLcontra.Text != "")
            {
                ...
                else
                {
                    ...
                    alerta.Text = "<script>Swal.fire('Error de sus credenciales', 'tu nombre de usuario o contraseña son incorrectos', 'error') </script>";
                    txtAname.Text = "";
                    txtLcontra.Text = "";
                }
            ...
            {
                alerta.Text = "<script>Swal.fire('CUIDADO', 'Llene todos los campos necesarios', 'error') </script>";
            }
